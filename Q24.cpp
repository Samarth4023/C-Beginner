/*company maintains employee information as employee id name designation and salary allow user to add delete information as employee .
display information of particular employee if employee does not exist an appropriate message is displayed if it is the system displays the employee details use index sequential file to maintain the data
*/
#include <iostream>
#include <fstream>
#include <stdio.h>
